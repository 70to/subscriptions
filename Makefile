...
laravel-install:
	docker-compose exec web composer create-project --prefer-dist laravel/laravel:^7.0 .
create-project:
	@make build
	@make up
...
install-recommend-packages:
	docker-compose exec web composer require doctrine/dbal "^2"
	docker-compose exec web composer require --dev ucan-lab/laravel-dacapo
