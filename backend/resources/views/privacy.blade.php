    ...
    <div class="relative bg-white overflow-hidden">
        <div class="relative px-4">
            ...
            <div class="prose prose-lg text-gray-500 mx-auto">
                ...
                <h3>第1条（個人情報の収集方法）</h3>
                <p>本サービスは、登録ユーザーが利用登録をする際に氏名やメールアドレスなどの個人情報をお尋ねすることがあります。また、登録ユーザーと提携先などとの間でなされた登録ユーザーの個人情報を含む取引記録や、決済に関する情報を本サービスの提携先（情報提供元、広告主、広告配信先などを含みます。以下、｢提携先｣といいます。）などから収集することがあります。
