...
@section('content-header')
    <div class="relative bg-white overflow-hidden">
        <div class="relative px-4">
            <p class="text-base text-center leading-6 text-indigo-600 font-semibold tracking-wide uppercase">Terms</p>
            ...
            <div class="prose prose-lg text-gray-500 mx-auto">
                <p>
                    この利用規約（以下「本規約」）は、本サービス運営者（以下「運営者」）がこのウェブサイト上で提供するサービス（以下「本サービス」）の利用条件を定めるものです。本サービスに登録および本サービスを閲覧されるご利用者（以下「ユーザー」）には、本規約に則って本サービスをご利用いただきます。</p>
                <h3>第1条（適用）</h3>
                <ol>
