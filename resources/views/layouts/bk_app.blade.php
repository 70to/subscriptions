...
<div id="app">
    <div class="">
        <div class="bg-gray-800 pb-32 px-24">
            ...
            <header class="py-10">
                <div class="max-w-7xl flex-shrink-0 flex justify-between items-center mx-auto px-4 sm:px-6 lg:px-8">
